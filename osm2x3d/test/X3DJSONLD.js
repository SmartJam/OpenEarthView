...
if (typeof Browser === 'undefined') {
    var Browser = {
        print: function(string) {
            if (typeof console !== 'undefined' && typeof string !== 'undefined') console.error(string);
        },
        ...
        createX3DFromString: function(string) {
            return loadX3DJS(undefined, JSON.parse(string), 'foo.json');
        }
    }
}
            ...
            if (arrayOfStrings) {
                ...
                if (parentkey === '@url' || parentkey.indexOf("Url") === parentkey.length - 3) {
                    ...
                    for (url in localArray) {
                        ...
                        if (localArray[url].indexOf("http://") === 0 || localArray[url].indexOf("https://") === 0) {} else if (localArray[url].indexOf("urn:web3d:media:textures/panoramas/") === 0) {
